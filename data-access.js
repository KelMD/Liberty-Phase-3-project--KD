...
const dbName = 'custdb';//Customer database
const baseUrl = "mongodb://127.0.0.1:27017";
const collectionName = "customers"//Collection within database
...
//Gets a record from the customer collection
...
//Resets the customer records in the database
